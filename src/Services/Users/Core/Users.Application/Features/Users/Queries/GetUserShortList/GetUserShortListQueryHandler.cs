...
{
    public class GetUserShortListQueryHandler : IRequestHandler<GetUserShortListQuery, List<GetUserShortDto>>
    {
        private readonly IUserFinder _userFinder;
        private readonly IMapper _mapper;

        public GetUserShortListQueryHandler(IUserFinder userFinder, IMapper mapper)
        {
