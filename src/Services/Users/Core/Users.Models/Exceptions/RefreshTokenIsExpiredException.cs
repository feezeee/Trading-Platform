...
namespace Users.Models.Exceptions
{
    public class RefreshTokenIsExpiredException : Exception
    {
        ...
        protected RefreshTokenIsExpiredException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
